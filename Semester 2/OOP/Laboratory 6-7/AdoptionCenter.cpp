...
/// <summary>
/// Simplifies the std built function for a Dog object
/// </summary>
/// <param name="Pet"></param> The dog to be found
/// <returns></returns>
auto Repository::find(Dog Pet)
{
	return std::find(this->repo.begin(), this->repo.end(), Pet);
}
...
/// <summary>
/// Gets the number of animal in the center
/// </summary>
/// <returns></returns>
int Repository::Size()
{
...
{
	this->file_name = "CSVRepository.csv";
}
...
{
	this->file_name = "HTMLRepository.html";
}
