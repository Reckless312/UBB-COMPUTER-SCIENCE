...
public class ForkStatement implements IStatement {
    ...
    public ProgramState execute(ProgramState currentState) throws StatementException {
        return new ProgramState(new MyStack<>(), currentState.getSymbolTable().deepCopy(),
                currentState.getOut(), currentState.getFileTable(), currentState.getHeap(), currentState.getSemaphoreTable(), currentState.getLockTable(), currentState.getLatchTable(), this.statement);
    }
